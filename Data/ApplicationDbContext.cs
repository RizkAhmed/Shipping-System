...
namespace Shipping_System.Data
{
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<OrderState>().HasData(new OrderState { Id = 3, Name = "Delivered to the representative" });
            builder.Entity<OrderState>().HasData(new OrderState { Id = 4, Name = "Delivered to the client" });
            ...
            builder.Entity<OrderState>().HasData(new OrderState { Id = 8, Name = "Canceled by the client" });
            builder.Entity<OrderState>().HasData(new OrderState { Id = 9, Name = "Declined but Paid" });
            builder.Entity<OrderState>().HasData(new OrderState { Id = 10, Name = "Declined but Partially Paid" });
            builder.Entity<OrderState>().HasData(new OrderState { Id = 11, Name = "Declined without Payment" });
